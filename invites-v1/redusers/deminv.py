...
parser.add_argument("-i", "--invite", 
	dest = "invite", 
	default = "users.csv", 
	help = "The csv file to invite users from.")
...
# string = '''
# Hey there! we are inviting ex-chodi's to our new platform after the ban. If you are recieveing this message, You posted at least once in the sub.
# Here's the website, bakchodi[dot]org. Meet you there Bhrata!
# '''
...
print(f"Invited {len(toSend)} Users succesfully.")
